...
# ========================PENTEST TOOLS DOWNLOAD SECTION========================

printf "\n${Cyan}Stage 4 Starting!\nDownloading Additional Pentest Tools...${Nc}\n"
...
download_linux_tools() {
    printf "\n${Cyan}Downloading Linux tools...${Nc}\n"
    cd "$LINUX_DIR"
    ...
    if [[ ! -f "kr" ]]; then
        download_and_extract "https://github.com/assetnote/kiterunner/releases/download/v1.0.2/kiterrunner_1.0.2_linux_amd64.tar.gz" "." "kiterunner"
    ...
    printf "${Cyan}Linux tools download complete${Nc}\n"
}

download_windows_tools() {
    printf "\n${Cyan}Downloading Windows tools...${Nc}\n"
    cd "$WINDOWS_DIR"
    ...
    printf "${Cyan}Windows tools download complete${Nc}\n"
}

download_basic_tools() {
    printf "\n${Cyan}Downloading basic tools...${Nc}\n"
    cd "$TOOLS_DIR"
    ...
    printf "${Cyan}Basic tools download complete${Nc}\n"
}

create_symlinks() {
    printf "\n${Cyan}Creating symlinks in /usr/local/bin...${Nc}\n"
    ...
    printf "${Cyan}Symlinks creation completed${Nc}\n"
}
...
printf "\n${Green}Tools downloaded to: $TOOLS_DIR${Nc}\n"
printf "${Cyan}Stage 4 Finished!\nPentest Tools Download Completed.${Nc}\n\n"

printf "\n${Cyan}All Stages Finished!\nRun this script 4-5 times. ${Red}WITH REOPENING TERMINAL AS ROOT. \n${Cyan}Check for missing tools in output and manually install.${Nc}\n\n"
